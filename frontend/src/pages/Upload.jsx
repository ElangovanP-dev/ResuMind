        ...
        >
          ...
          {loading ? (
            <div className="flex flex-col items-center gap-4 py-4">
              ...
              <p className="text-indigo-400 font-semibold text-lg">Analyzing your resume…</p>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-slate-400 text-sm">{(file.size / 1024 / 1024).toFixed(2)} MB · PDF</p>
              <button
                className="text-slate-500 hover:text-slate-300 text-xs mt-1 transition-colors"
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                <p className="text-white font-semibold text-lg">
                  Drop your PDF here, or <span className="text-indigo-400">browse</span>
                </p>
